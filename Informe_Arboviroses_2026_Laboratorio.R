...
for (j in 1:53){
  for (i in BASE_IBGE[(which(BASE_IBGE$RS == RS)), 3]){
    RS22_2025_SE_PESQ_ARB[which(RS22_2025_SE_PESQ_ARB == i), O] <- as.integer(RS22_2025_LACEN_PESQ_ARBO%>%
...
for (j in 1:53){
  for (i in BASE_IBGE[(which(BASE_IBGE$RS == 22)), 3]){
    RS22_2025_SE_PESQ_ARB_DETECTAVEL[which(RS22_2025_SE_PESQ_ARB_DETECTAVEL == i), O] <- as.integer(RS22_2025_LACEN_PESQ_ARBO%>%
                                                                                                      filter(Municipio_Residencia == i,
                                                                                                             SE == N,
...
for (j in 1:53){
  for (i in BASE_IBGE[(which(BASE_IBGE$RS == RS)), 3]){
    RS22_2025_SE_US[which(RS22_2025_SE_US == i), O] <- as.integer(RS22_2025_LACEN_PESQ_ARBO%>%
...
for (j in 1:53){
  for (i in BASE_IBGE[(which(BASE_IBGE$RS == RS)), 3]){
    RS22_2025_SE_US_DETECTAVEL[which(RS22_2025_SE_US_DETECTAVEL == i), O] <- as.integer(RS22_2025_LACEN_PESQ_ARBO%>%
                                                                                          filter(Municipio_Requisitante == i,
                                                                                                 SE == N,
                                                                                                 Requisitante == "POSTO DE SAUDE CENTRAL DE IVAIPORA",
                                                                                                 Resultado == "Detectável ") %>%
...
for (j in 1:53){
  for (i in BASE_IBGE[(which(BASE_IBGE$RS == RS)), 3]){
    RS22_2025_SE_SOROLOGIA[which(RS22_2025_SE_SOROLOGIA == i), O] <- as.integer(RS22_2025_LACEN_SOROLOGIA%>%
                                                                                  filter(Municipio_Residencia == i,
                                                                                         SE == N,
                                                                                         Status_Exame == "Resultado Liberado" |
                                                                                           Status_Exame == "Automaçăo em Processamento" |
...
for (j in 1:53){
  for (i in BASE_IBGE[(which(BASE_IBGE$RS == RS)), 3]){
    RS22_2025_SE_SOROLOGIA_REAGENTE[which(RS22_2025_SE_SOROLOGIA_REAGENTE == i), O] <- as.integer(RS22_2025_LACEN_SOROLOGIA%>%
                                                                                                    filter(Municipio_Residencia == i,
                                                                                                           SE == N,
                                                                                                           Resultado == "Reagente " |
                                                                                                             Resultado == "Reagente") %>%
